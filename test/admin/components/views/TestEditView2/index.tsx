...
import { DocumentHeader } from '../../../../../packages/payload/src/admin/components/elements/DocumentHeader'
import { FormLoadingOverlayToggle } from '../../../../../packages/payload/src/admin/components/elements/Loading'
import Form from '../../../../../packages/payload/src/admin/components/forms/Form'
import { useActions } from '../../../../../packages/payload/src/admin/components/utilities/ActionsProvider'
import { useAuth } from '../../../../../packages/payload/src/admin/components/utilities/Auth'
import { useDocumentEvents } from '../../../../../packages/payload/src/admin/components/utilities/DocumentEvents'
import { OperationContext } from '../../../../../packages/payload/src/admin/components/utilities/OperationProvider'
import { CollectionRoutes } from '../../../../../packages/payload/src/admin/components/views/collections/Edit/Routes'
import { CustomCollectionComponent } from '../../../../../packages/payload/src/admin/components/views/collections/Edit/Routes/CustomComponent'
// import './index.scss'
...
const TestEditView2: React.FC<DefaultEditViewProps> = (props) => {
